...
// import { BACKEND_SHOP } from "../../utils/constant";
...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .put(
        `${BACKEND_SHOP}/shop/update-payment-methods`,
        {
          withdrawMethod,
        },
  ...
  const deleteHandler = async () => {
    await axios
      .delete(`${BACKEND_SHOP}/shop/delete-withdraw-method`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const withdrawHandler = async () => {
    if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
      ...
      await axios
        .post(
          `${BACKEND_SHOP}/withdraw/create-withdraw-request`,
          { amount },
          { withCredentials: true }
        )
        .then((res) => {
